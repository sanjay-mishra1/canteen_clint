...
import com.example.sanjay.canteen_clint.message.MyAdapter;
import com.example.sanjay.canteen_clint.message.chat_window;
...
public class chat_app_Activity extends AppCompatActivity {
    ...
    void check( ){
     ...
     protected void ONStart(final DatabaseReference databaseReference) {
               ...
               try {
                ...
                viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent=new Intent(chat_app_Activity.this,help_activity.class);
